...
#Our image vectors
x = tf.placeholder(tf.float32, shape=[None, 262144]) #Image vectors - size of pi input
y_ = tf.placeholder(tf.float32, shape=[None, 5]) #One-hot vectors - TODO: change to X number of labels (cur: 3)
